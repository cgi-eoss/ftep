 ...
 * Required includes
 */
require_once 'PostgreSQL/Functions_general.php';
require_once 'PostgreSQL/Functions_cart.php';
require_once 'PostgreSQL/Functions_collections.php';
require_once 'PostgreSQL/Functions_facets.php';
require_once 'PostgreSQL/Functions_features.php';
require_once 'PostgreSQL/Functions_filters.php';
require_once 'PostgreSQL/Functions_licenses.php';
require_once 'PostgreSQL/Functions_rights.php';
require_once 'PostgreSQL/Functions_users.php';
require_once 'PostgreSQL/Functions_history.php';
