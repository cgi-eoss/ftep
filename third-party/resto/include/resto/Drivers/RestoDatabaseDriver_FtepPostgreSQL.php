...
require_once __DIR__.'/PostgreSQL/Ftep_Functions_features.php';
require_once __DIR__.'/PostgreSQL/Ftep_Functions_filters.php';
 ...
 */
class RestoDatabaseDriver_FtepPostgreSQL extends RestoDatabaseDriver_PostgreSQL {
    ...
    public function get($typeName, $params = array()) {
        switch ($typeName) {
            ...
            case parent::FEATURE_DESCRIPTION:
                $featuresFunctions = new Ftep_Functions_features($this, __DIR__.'/../../ftep_config.php');
