-- Flyway-compatible schema installation for Resto v2.4, interpreted from installDB.sh

-- This script must be run as a superuser to install the extensions and alter functions
